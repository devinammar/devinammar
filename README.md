...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/devinammar/devinammar/output/pacman-contribution-graph-dark.svg">
...
<div id="container" style="color:#999; text-transform: uppercase; font-size:36px; font-weight:bold; padding-top:200px; position:fixed; width:100%; bottom:45%; display:block;">
  ...
  <div id="flip" style="height:50px; overflow:hidden;">
    <div style="color:#fff; padding:4px 12px; height:45px; margin-bottom:45px; display:inline-block; animation: show 5s linear infinite;">
      <div style="background:#4ec7f3;">wOrK</div>
    </div>
    <div style="color:#fff; padding:4px 12px; height:45px; margin-bottom:45px; display:inline-block; animation: show 5s linear infinite;">
      <div style="background:#42c58a;">lifeStyle</div>
    </div>
    <div style="color:#fff; padding:4px 12px; height:45px; margin-bottom:45px; display:inline-block; animation: show 5s linear infinite;">
      <div style="background:#DC143C;">Everything</div>
    </div>
  </div>
  AweSoMe!
</div>

<p style="position:fixed; width:100%; bottom:30px; font-size:12px; color:#999; margin-top:200px;">a css3 animation demo</p>
